...
import com.shubham.explorecali.service.TourRatingService;
...
public class TourRatingController {
    ...
    public PagedModel<RatingDto> getAllRatingsForTour(@PathVariable(value = "tourId") int tourId, Pageable pageable,
        ...
        PagedModel<RatingDto> result =  pagedAssembler.toModel(tourRatingPage, assembler);
        return result;
    }
    ...
    private RatingDto toDto(TourRating tourRating) {
        return assembler.toModel(tourRating);
    }
